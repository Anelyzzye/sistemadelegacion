<div class="col-lg-8 col-sm-12 container">
    <big><big>
     <a href="http://localhost/sistema_delegacion/index.php/ExportaHistorial_porfecha/exportaPDF/<?= $criterio  ?>"><button class="btn btn-default"> Descargar Reporte PDF</button></a>
       </big></big>
                            ...
                            <div>
                                <table class="table table-responsive table-hover table-bordered">
                                    ...
                                    echo "</tr>";
                                    echo "<tr>";
                                    foreach ($resultadofecha as $object) {
